...
void Style::parseAttributes(XmlReader &reader)
{
...
bool Style::parseAttribute(const char *attribute, const char *value)
{
    ...
    else if (strcmp(attribute, "font-size") == 0)
    {
        ...
        {
            std::cerr << "Warning problem parsing size '" << value << "'\n";
        }
    }
