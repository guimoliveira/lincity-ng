...
class IndustryHeavy : public RegisteredConstruction<IndustryHeavy>
{ // IndustryHeavy inherits from its own RegisteredConstruction
public:
    ...
    virtual void initialize() override
    {
        ...
        int steel_prod = MAX_ORE_USED / ORE_MAKE_STEEL;
        commodityMaxProd[STUFF_WASTE] = 100 * (int)(((double)(POL_PER_STEEL_MADE * steel_prod) * bonus) * (1 - extra_bonus));
    }
